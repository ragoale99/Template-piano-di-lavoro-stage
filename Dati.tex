...
\newcommand{\cognomeTutorAziendale}{Scettro}
\newcommand{\emailTutorAziendale}{fabio.scettro@synclab.it}
\newcommand{\telTutorAziendale}{+39 342 899 3976}
\newcommand{\ruoloTutorAziendale}{dott.}
...
\newcommand{\prospettoSettimanale}{
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Implementazione maschera di login e di voto online con Angular.
        \end{itemize}
        ...
        \begin{itemize}
            \item Implementazione maschera di login e di voto online con VueJS.
        \end{itemize}
        \item \textbf{Sesta Settimana (40 ore)} 
        \begin{itemize}
            \item Implementazione maschera di login e di voto online con React.
        \end{itemize}
